...
@section('content')
    ...
    @else
        ...
        <div class="alert alert-info">
            You have <strong>one attempt</strong> at this quiz. Review your answers before submitting.
        </div>

        <form action="{{ route('student.quizzes.submit', $quiz->quiz_id) }}" method="POST">
            @csrf
